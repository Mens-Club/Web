...
urlpatterns = [
    ...
    path('mypage/by-time/', RecommendBookmarkByTimeAPIView.as_view(), name='bookmark_by_time'),
    path('mypage/by-price/', RecommendBookmarkByPriceAPIView.as_view(), name='bookmark_by_price'),
    path('mypage/by-style/', RecommendBookmarkByStyleAPIView.as_view(), name='bookmark_by_style'), # db에 style없어서 현재 수정 불가. migrations 해야함.
