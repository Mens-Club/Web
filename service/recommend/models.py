...
class MainRecommendation(models.Model):
    ...
    top = models.ForeignKey("clothes.Clothes", to_field="idx", on_delete=models.SET_NULL, null=True, blank=True, related_name="main_top")
    bottom = models.ForeignKey("clothes.Clothes", to_field="idx", on_delete=models.SET_NULL, null=True, blank=True, related_name="main_bottom")
    outer = models.ForeignKey("clothes.Clothes", to_field="idx", on_delete=models.SET_NULL, null=True, blank=True, related_name="main_outer")
    shoes = models.ForeignKey("clothes.Shoes", to_field="idx", on_delete=models.SET_NULL, null=True, blank=True, related_name="main_shoes")
...
class MainRecommendationBookmark(models.Model):
    ...
    user = models.ForeignKey(
        User, 
        on_delete=models.CASCADE,
        related_name="main_recommendation_bookmarks"
    )
    
    main_recommendation = models.ForeignKey(
        MainRecommendation,
        on_delete=models.CASCADE,
        related_name='main_bookmarks'
    )
